...
export default function SriLankanHoppers() {
   ...
   const detailsections = [
  {
    ...
    image: "/images/Visit-Images/SubPages/sri-lankan-hoppers/mullai-suvai-ootru.jpg",
  ...
  {
    id: 2,
    title: "Ceylon Pastries - Injambakkam",
    image: "/images/Visit-Images/SubPages/sri-lankan-hoppers/ceylon-pastries.jpg",
    // link1: "https://www.littleitaly.in/",
    link2: "https://maps.app.goo.gl/nuFMzkwfsE9JVTX78",
    rating: 3.9,
  },
  {
    id: 3,
    title: "Bodhi’s Indo-Lankan Cuisine - Madipakkam",
    image: "/images/Visit-Images/SubPages/sri-lankan-hoppers/bodhis-indo-lankan-cuisine.jpg",
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              <h3>Sri Lankan Hoppers</h3>
              <div className="breadCrum">
               <Link to="/visit"> Visit </Link> - <Link to="/food"> Food </Link> - <a href=""> Sri Lankan Hoppers </a>
              </div>
            </div>
          </div>
