...
export default function ThingstoBowlingAlleys() {
  ...
  const detailsections = [
    {
      id: 1,
      title: "Nassaa Uth Hub: Besant Nagar, Egattur (Marina Mall), ECR ",
      image:
    ...
    {
      id: 3,
      title: "Lets Bowl: Thoraipakkam",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Bowling Alleys/lets-bowl.jpg",
      link1: "https://letsbowlchennai.in/",
      link2: "https://maps.app.goo.gl/pEXSWRfMATyvHKyJ9",
      rating: 4.4,
    },
    {
      id: 4,
      title: "Timezone: VR Mall (Anna Nagar), Palladium Mall (Velachery)",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Bowling Alleys/timezone-vr-mall.jpg",
      link1: "#",
      link2: "https://maps.app.goo.gl/jQ6ujgqt99EbTTsQ6",
      rating: 4.4,
    },
    {
      id: 5,
      title: "Masti Zone: Navalur",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Bowling Alleys/masti-zone.jpg",
      link1: "https://mastizone.co.in/",
      link2: "https://maps.app.goo.gl/rxFnJw7XNA8dstWT6",
      rating: 4.4,
    },
    {
      id: 6,
      title: "Potentially Mayajaal Bowling Alley: ECR ",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Bowling Alleys/mayajaal-bowling-alley.jpg",
      link1: "https://www.mayajaal.com/bowling-and-games",
      link2: "https://maps.app.goo.gl/UFPdsSaqzSGccgBE9",
      rating: 4.4,
    },
  ];
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Bowling Alleys</h3>
              <p>
                Here the players bowl balls to knock down pins with automated
                scoring.
              </p>
            </div>
          </div>
