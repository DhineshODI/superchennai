...
export default function ThingstodoHorrorHouse() {
  ...
  const detailsections = [
    {
      id: 1,
      title: "The Marina Mall: OMR (Old Mahabalipuram Road)",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Horror Houses/the-marina-mall.jpg",
      link1: "https://marinamallchennai.com/entertainment/horror-house/",
      link2: "https://maps.app.goo.gl/Aps4q6wZzX2oPhUR8",
      rating: 2.0,
    },
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Horror Houses</h3>
              <p>
                The human will be made up like a ghost to create a fear in the
                visitors, which thrills you.
              </p>
            </div>
          </div>
        </div>
