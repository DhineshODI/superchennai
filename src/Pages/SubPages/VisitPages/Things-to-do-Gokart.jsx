...
export default function ThingstodoGokart() {
  ...
  const detailsections = [
    {
      id: 1,
      title: "Kart Attack: Panaiyur.",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Go-Karting/kart-attack.jpg",
      link1: "https://www.kartattack.com/",
      link2: "https://maps.app.goo.gl/xaxAUzoLS4Z3kbox8",
      rating: 4.1,
    },
    {
      id: 2,
      title: "ECR Speedway: Kanathur.",
      image:
        "/images/Visit-Images/SubPages/Things-to-do/Go-Karting/ecr-speedway.jpg",
      link1: "https://rfactormotorsports.com/",
      link2: "https://maps.app.goo.gl/CCxHAxebvmckcnjc6",
      rating: 4.5,
    },
  ];
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Go-Karting</h3>
              <p>
                Here the participants drive a small, open-wheeled car for fun or
                racing.
              </p>
            </div>
          </div>
