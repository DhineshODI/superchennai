  ...
  const detailsections = [
    {
      ...
      image:
        "/images/Visit-Images/SubPages/Place-to-visit/cultural foundations/kalakshetra-foundation.jpg",
      link1:
        "https://www.kalakshetra.in/",
      link2: "https://maps.app.goo.gl/bUE5eV2GpSkTmbTr6",
      rating: 4.5,
    },
    {
      id: 2,
      ...
      image:
        "/images/Visit-Images/SubPages/Place-to-visit/cultural foundations/dakshinachitra-museum.jpg",
      link1: "https://www.dakshinachitra.net/",
      link2: "https://maps.app.goo.gl/QhXwdCVuucpYZbvv8",
      rating: 4.4,
    },
    {
      id: 3,
      title: "M. Rm. Rm. Cultural Foundation (MRC Nagar)",
      image:
        "/images/Visit-Images/SubPages/Place-to-visit/cultural foundations/m-rm-rm-cultural-foundation.jpg",
      link1:
        "https://www.mrmrmculturalfoundation.com/",
      link2: "https://maps.app.goo.gl/AcFThZgwaHzVwx22A",
      rating: 4.4,
    },
    {
      id: 4,
      title: "Prakriti Foundation (Teynampet)",
      image:
        "/images/Visit-Images/SubPages/Place-to-visit/cultural foundations/prakriti-foundation.jpg",
      link1: "https://prakritifoundation.com/",
      link2: "https://maps.app.goo.gl/TtX1WV21oCa7x9LK9",
      rating: 4.1,
    },
    {
      id: 5,
      title: "Kala Kendra (Adyar)",
      image:
        "/images/Visit-Images/SubPages/Place-to-visit/cultural foundations/kala-kendra.jpg",
        link1: "https://kalakendra.com/",
      link2: "https://maps.app.goo.gl/s49CXuuUZAFesDNv8",
      rating: 3.5,
    },
  ];
        ...
        <div className="accaodomationBannerSection">
          ...
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              <h3>Cultural Foundations</h3>
              <div className="breadCrum">
                <Link to="/visit"> Visit </Link> -{" "}
                 <Link to="/placestovisit"> Places to Visit </Link> -{" "}
                <a href="">Cultural Foundations</a>
              </div>
            </div>
          </div>
        ...
        <div className="visitIntroParaSection detailIntro">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            <div className="workIntro">
              <h3>Cultural Foundations</h3>
              <p>
                Take in the mesmerizing performances of traditional art, which
