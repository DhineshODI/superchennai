...
export default function Midrangehotelsnew() {
   ...
   const detailsections = [
  {
    ...
    image: "/images/Visit-Images/SubPages/itc-hotels.png",
    link1: "https://www.itchotels.com/in/en",
    link2: "https://maps.app.goo.gl/79xzVEp3UvZQM38d6",
    rating: 4.5,
  },
  {
    id: 2,
    title: "The Leela Palace Chennai",
    image: "/images/Visit-Images/SubPages/the-leela-palace.jpg",
    link1: "https://www.theleela.com/",
    link2: "https://maps.app.goo.gl/LtBxCzb5tLdjQMJk9",
    rating: 4.0,
  },
  {
    id: 3,
    title: "Taj Connemara, Chennai",
    image: "/images/Visit-Images/SubPages/taj-hotels.jpg",
    link1: "https://www.tajhotels.com/en-in",
    link2: "https://maps.app.goo.gl/96MDg1V9bc9iaVzb8",
    rating: 5.0,
  },
  {
    id: 4,
    title: "Hilton Chennai",
    image: "/images/Visit-Images/SubPages/Hilton-hotels.jpg",
    link1: "https://www.hilton.com/en/hotels/maahihi-hilton-chennai/",
    link2: "https://maps.app.goo.gl/eRBfneay4H2aZPDW6",
    rating: 4.5,
  },
  {
    id: 5,
    title: "The Raintree St. Mary's Road",
    image: "/images/Visit-Images/SubPages/The-Raintree.jpg",
    link1: "https://www.raintreehotels.com/",
    link2: "https://maps.app.goo.gl/akSNnptLzHBbDqri8",
    rating: 3.5,
  },
];
    ...
    <>
      <div>
        ...
        <div className="accaodomationBannerSection">
          <img src="images/Visit-Images/SubPages/Luxury-Hotels-banner.jpg" alt="" />
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              <h3>Luxury Hotels </h3>
              <div className="breadCrum">
              <Link to="/visit"> Visit </Link> - <Link to="/accomodation"> Visit </Link> - <a href="">Luxury Hotels </a>
              </div>
            </div>
          </div>
