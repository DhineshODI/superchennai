...
export default function BudgetStays() {
  ...
  {
    id: 1,
    title: "A.R Residency - Chennai",
    image: "/images/Visit-Images/SubPages/BUDGET-STAYS/AR-Residency.jpg",
    // link1: "https://www.itchotels.com/in/en",
    link2: "https://maps.app.goo.gl/8ycwVEp8jhAdMV6W6",
    rating: 4.5,
  },
  {
    id: 2,
    title: "Hotel Pandian - Egmore",
    image: "/images/Visit-Images/SubPages/BUDGET-STAYS/Hotel-Pandian.jpg",
    link1: "https://hotelpandian.com/",
    link2: "https://maps.app.goo.gl/BjGrrDGVuEgRbbR28",
    rating: 4.0,
  },
  {
    id: 3,
    title: "Hotel O Triplicane (formerly Park Royal) -Triplicane",
    image: "/images/Visit-Images/SubPages/BUDGET-STAYS/Hotel-O-Triplicane-formerly-Park-Royal.jpg",
    // link1: "https://www.tajhotels.com/en-in",
    link2: " https://maps.app.goo.gl/8wW7rRrF3wXs7r5s7",
    rating: 5.0,
  },
  {
    id: 4,
    title: "ibis Chennai City Centre -Anna Salai",
    image: "/images/Visit-Images/SubPages/BUDGET-STAYS/ibis-Chennai-City-Centre.jpg",
    // link1: "https://www.hilton.com/en/hotels/maahihi-hilton-chennai/",
    link2: "https://maps.app.goo.gl/N24tWPFBnLMq9f8o6",
    rating: 4.5,
  },
  {
    id: 5,
    title: "Green Tree Hotel – Near VFS Global and Ramee Mall -Teynampet",
    image: "/images/Visit-Images/SubPages/BUDGET-STAYS/Green-Tree-Hotel.jpg",
    // link1: "https://www.raintreehotels.com/",
    link2: "https://www.greenhotelgroups.com/gt_tree/index.html",
    rating: 3.5,
  },
];
    ...
    <>
      <div>
        ...
        <div className="accaodomationBannerSection">
          <img src="images/Visit-Images/SubPages/budget-stays.jpg" alt="" />
          <div className="accodoamationBannerContainer">
            <div className="accodoamationBannerText">
              <h3>Budget Stays </h3>
              <div className="breadCrum">
              <Link to="/visit"> Visit </Link> - <Link to="/accomodation"> Accomodation </Link> - <a href="">Budget Stays </a>
              </div>
            </div>
          </div>
