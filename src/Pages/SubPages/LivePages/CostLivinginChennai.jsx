...
export default function FutureGrowthDevelopment() {
  ...
  const single = [
    ...
    },
    {
      ...
      imgs: "/images/costofliving/ClothingIcon.svg",
    },
    {
      id: 6,
      title: "Food",
      ...
      imgs: "/images/costofliving/FoodIcon.svg",
    },
    {
      id: 7,
      title: "Entertainment",
      ...
      imgs: "/images/costofliving/EntertainmentIcon.svg",
    },
  ];
  const couple = [
    {
  ...
  return (
    <>
      <section className="inpageBan">
        <img src="/images/Live-Images/SubPages/clcbanimg.jpg" alt="" />
      </section>
